...
export default function Chat() {
  const [messages, setMessages] = useState([
    { role: "ai", content: "Hi, I'm Psycin. You can drop your thoughts here — this is a safe, private space. 💙" },
  ]);
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { role: "ai", content: "Sorry, I lost my train of thought. Let's try that again." },
      ]);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="chat-root">
      {/* 3D Background mimicking the Homepage */}
      ...
      <div className="chat-container">
        ...
        <div className="chat-input-area">
          ...
          <p className="chat-input-hint">Enter to send · Your conversations are private & encrypted</p>
        </div>
